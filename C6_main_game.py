...
class Menu:
    ...
    def __init__(self):
        ...
        for item in range(0, 3):
            self.rounds_button = RoundedButton(self.rounds_frame, width=80, height=30, fg=button_fg,
...
class Play:
    ...
    def __init__(self, how_many):
        ...
        control_buttons = [
            ["#BD5753", "Start Over"], ["#BD5753", "History / Statistics"], ["#BD5753", "New Round "]
        ]
...
# can you make the buttons disabled when user clicked an option so the user can move on to the next round
